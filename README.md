## Length of Hospital Stay Outcome Predictor
 **Samantha Turner**
### Synopsis
...
<br>**Length of Stay (Regression):** number of days the patient is in the hospital
<br>**Mortality Risk (Classification):** probability of patient hospital death
### Dataset Used
...
**Admissions.csv** : subject_id, admittime, dischtime, diagnosis, hospital_expire_flag
...
- Itemid(lab test type): top ten tests performed selected, aggregated per patient to calculate mean and count of each test. Missing value filled (mean -> median, count -> 0)
